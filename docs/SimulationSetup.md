...
# Simulation Setup [](https://docs.robotsfan.com/isaacgym/programming/simsetup.html\#simulation-setup "Permalink to this heading")
...
## Creating a Simulation [](https://docs.robotsfan.com/isaacgym/programming/simsetup.html\#creating-a-simulation "Permalink to this heading")
...
### Simulation Parameters [](https://docs.robotsfan.com/isaacgym/programming/simsetup.html\#simulation-parameters "Permalink to this heading")
...
> - [tuning simulation parameters](https://docs.robotsfan.com/isaacgym/programming/tuning.html#tuning-sim-params)
>
> - [`isaacgym.gymapi.SimParams`](https://docs.robotsfan.com/isaacgym/api/python/struct_py.html#isaacgym.gymapi.SimParams "isaacgym.gymapi.SimParams")
>
> - [`isaacgym.gymapi.PhysXParams`](https://docs.robotsfan.com/isaacgym/api/python/struct_py.html#isaacgym.gymapi.PhysXParams "isaacgym.gymapi.PhysXParams")
>
> - [`isaacgym.gymapi.FlexParams`](https://docs.robotsfan.com/isaacgym/api/python/struct_py.html#isaacgym.gymapi.FlexParams "isaacgym.gymapi.FlexParams")

#### Up Axis [](https://docs.robotsfan.com/isaacgym/programming/simsetup.html\#up-axis "Permalink to this heading")
...
### Creating a Ground Plane [](https://docs.robotsfan.com/isaacgym/programming/simsetup.html\#creating-a-ground-plane "Permalink to this heading")
...
## Loading Assets [](https://docs.robotsfan.com/isaacgym/programming/simsetup.html\#loading-assets "Permalink to this heading")
...
The import options affect the physical and visual characteristics of the model, thus may have an impact on simulation stability and performance. More detail can be found in the chapter on [Assets](https://docs.robotsfan.com/isaacgym/programming/assets.html).
...
More information about the math utilities can be found in [Math Utilities](https://docs.robotsfan.com/isaacgym/programming/math.html).
...
The two integers at the end of the argument list are **collision\_group** and **collision\_filter**. These values play an important role in the physics simulation of actors.

- **collision\_group** is an integer that identifies the collision group to which the actor’s bodies will be assigned. Two bodies will only collide with each other if they belong to the same collision group. It is common to have one collision group per environment, in which case the group id corresponds to the environment index. This prevents actors in different environments from interacting with each other physically. In certain cases, you may wish to set up more than one collision group per environment for more fine-grained control. The value -1 is used for a special collision group that collides with all other groups. This can be used to create “shared” objects that can physically interact with actors in all environments.

- **collision\_filter** is a bit mask that lets you filter out collision between bodies. Two bodies will _not_ collide if their collision filters have a common bit set. This value can be used to filter out self-collisons in multi-body actors or prevent certain kinds of objects in a scene from interacting physically.
...
## Running the Simulation [](https://docs.robotsfan.com/isaacgym/programming/simsetup.html\#running-the-simulation "Permalink to this heading")
...
## Adding a Viewer [](https://docs.robotsfan.com/isaacgym/programming/simsetup.html\#adding-a-viewer "Permalink to this heading")
...
This pops up a window with the default dimensions. You can set different dimensions by customizing the [`isaacgym.gymapi.CameraProperties`](https://docs.robotsfan.com/isaacgym/api/python/struct_py.html#isaacgym.gymapi.CameraProperties "isaacgym.gymapi.CameraProperties").
...
### The Viewer GUI [](https://docs.robotsfan.com/isaacgym/programming/simsetup.html\#the-viewer-gui "Permalink to this heading")
...
### Custom Mouse/Keyboard Input [](https://docs.robotsfan.com/isaacgym/programming/simsetup.html\#custom-mouse-keyboard-input "Permalink to this heading")
...
## Cleanup [](https://docs.robotsfan.com/isaacgym/programming/simsetup.html\#cleanup "Permalink to this heading")
