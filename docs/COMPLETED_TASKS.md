...
- [X] Bump was registered by measuring force exerted on the robot body, however, only horrizontal forces (x-z) plane should be measured. Otherwise the robot reports constant bump.
